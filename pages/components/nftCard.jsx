    ...
    return (
        <div className="w-1/4 flex flex-col ">
            ...
            <div className="flex justify-center mb-1">
                <a  className="py-2 px-4 bg-blue-500 w-1/2 text-center rounded-m text-white cursor-pointer" target={"_blank"} href={`https://polygonscan.com/token/${nft.contract.address}`}> View on Polygonscan </a>
            </div>
        </div>
    )
}
